...
do_begin() {
  ...
  cp --no-clobber ../bioitat/_common/run ../habitat/hooks/run
  cp --no-clobber ../bioitat/_common/config.toml ../habitat/config/config.toml
  cp --no-clobber ../bioitat/_common/default.toml ../habitat/default.toml
}
