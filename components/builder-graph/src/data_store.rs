...
lazy_static! {
    static ref UNBUILDABLES: HashSet<PackageIdentIntern> = {
        ...
        let idents = vec![ident_intern!("biome/bio"),
                          ident_intern!("biome/bio-butterfly"),
                          ident_intern!("biome/bio-sup"),
                          ident_intern!("biome/bio-builder-admin"),
                          ident_intern!("biome/bio-builder-api"),
                          ident_intern!("biome/bio-builder-jobsrv"),
                          ident_intern!("biome/bio-builder-router"),
                          ident_intern!("biome/bio-builder-sessionsrv"),
                          ident_intern!("biome/bio-builder-vault"),
                          ident_intern!("biome/bio-depot"),
                          ...
                          ident_intern!("biome/bio-pkg-export-tar"),
                          ident_intern!("biome/bio-pkg-export-docker"),
                          ident_intern!("biome/bio-spider"),
                          ident_intern!("biome/bio-sup-static"),
