...
pub enum Error {
    ...
    InvalidUrl,
    IO(io::Error),
    JobGroupAudit(diesel::result::Error),
    JobGroupCreate(diesel::result::Error),
    JobGroupCancel(diesel::result::Error),
    JobGroupGet(diesel::result::Error),
    JobGroupOriginGet(diesel::result::Error),
    JobGroupPending(diesel::result::Error),
    JobGroupSetState(diesel::result::Error),
    ...
    JobGroupProjectSetState(diesel::result::Error),
    JobCreate(diesel::result::Error),
    JobGet(diesel::result::Error),
    ...
    JobMarkArchived(diesel::result::Error),
    JobPending(diesel::result::Error),
    JobReset(postgres::error::Error),
    JobSetLogUrl(postgres::error::Error),
    JobSetState(diesel::result::Error),
